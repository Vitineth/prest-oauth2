...
/**
 * Representation of the details for an refresh token within the OAuth2 grant flow.
 */
export class OAuth2RefreshToken{
    ...
    /**
     * The actual code to be sent with the requests.
     */
     ...
     * the access token that the user is trying to refresh.
     */
    ...
    /**
     * This references the [[OAuth2Client._id]] that this refresh token is bound to.
     */
     ...
     * @param code The actual code to be sent with the requests.
     * @param expires The date and time at which the token is set to expire. This should be formatted as a unix
     * timestamp.
     * @param raw_scopes This is the raw string of scopes that should be saved. This can be formatted in any way that
     * you wish but you must be able to split the scope in the future in order to populate [[scopes]]. This will be
     * used to compare with the access token that the user is trying to refresh.
     ...
     * @param client_id This references the [[OAuth2Client._id]] that this refresh token is bound to.
     * @param client This is the actual client represented by the [[_client_id]].
     * @param user_id This references the user that requested the access token originally. This is an implementation
     * specific id for the user. This should allow a client to reference their own internal user structures instead of
     * string to mould theirs around this implementation. Implementation of this will vary depending on how you are
     * addressing the users and storing them. This is designed to be used with a database implementation but if your
     * implementation varies then you can handle this however you want.
